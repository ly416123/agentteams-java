 ...
 */
public final class ManagerModelPriceCatalogAdapter implements io.agentteams.manager.ModelPriceCatalog {
    ...
    @Override
    public void register(io.agentteams.manager.ModelPrice price) {
        throw new UnsupportedOperationException("Control Plane price catalog is read-only in Manager");
    }

    @Override
    public Optional<io.agentteams.manager.ModelPrice> find(String provider, String model, String currency) {
    ...
    private static io.agentteams.manager.ModelPrice toManagerPrice(ModelPriceRecord price) {
        return new io.agentteams.manager.ModelPrice(price.provider(), price.model(), price.currency(),
