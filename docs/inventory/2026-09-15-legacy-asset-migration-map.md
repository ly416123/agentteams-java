...
| common-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/common/sse | - | 否 |
| strategy-server-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/strategy/sse | - | 否 |
| supplier-recommender-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/procurement/sse | - | 否 |
| risk-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/risk/sse | - | 否 |
...
| sales-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/sales/sse | - | 否 |
...
| data-artifact-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/data-artifact/sse | - | 否 |
...
| memory-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/memory/sse | - | 否 |
| feedback-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/feedback/sse | - | 否 |
| order-mcp-dev | prod-candidate | SSE | http://corp-map-dev-api-beijing.10000da.vip:80/corp-agent-app/order/sse | - | 否 |
| financial-ask | prod-candidate | STREAMABLE_HTTP | https://dashscope.aliyuncs.com/api/v1/mcps/market-cmapi00073529/mcp | - | 否 |
| web-search | prod-candidate | STREAMABLE_HTTP | https://dashscope.aliyuncs.com/api/v1/mcps/WebSearch/mcp | - | 否 |
...
环境标记统计：{'prod-candidate': 15, 'test': 1, 'uat': 3, 'variant': 3}
