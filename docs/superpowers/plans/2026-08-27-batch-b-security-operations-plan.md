...
- 创建：`control-plane/src/main/java/io/agentteams/controlplane/worker/WorkerOperation.java`、`WorkerOperationStatus.java`、`WorkerOperationType.java`、`WorkerRolloutRequest.java`、`WorkerOperationService.java`、`WorkerOperationRepository.java`。
