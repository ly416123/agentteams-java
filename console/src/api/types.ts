...
export type WorkerOperation = {
  ...
  requestedSecretGeneration?: string;
  failureCategory?: string;
  expectedAgentVersion?: number;
  operatorReady?: boolean;
  operatorSpecDigest?: string;
  operatorRuntime?: string;
  operatorConfigRevision?: string;
  operatorObservedAt?: string;
  gatewayOnline?: boolean;
  gatewaySpecDigest?: string;
  gatewayRuntime?: string;
  gatewayConfigRevision?: string;
  gatewayObservedAt?: string;
